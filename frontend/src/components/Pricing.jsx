  ...
  return (
    ...
    >
      ...
      <Button
        ...
        variant={featured ? 'secondary' : 'outlined'}
        asChild
      >
      ...
      <Container>
        <div className="md:text-center">
          ...
          <p className="mt-4 text-lg text-slate-400">
            It doesn&apos;t matter the scale of your project, our API seamlessly
            integrates with every development journey.
          </p>
        </div>
        <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
          <Plan
            description="Take it for a spin. Build a small project."
            features={[
          ...
          />
          <Plan
            description="Perfect for a small to medium sized project"
            featured
            features={[
          ...
          />
          <Plan
            description="For even larger projects."
            features={[
